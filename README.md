This is a simple shopping list app built with SvelteKit, Tailwind and Firebase Authentication and Database. It allows users to create an account, log in, and manage their personal shopping list.
